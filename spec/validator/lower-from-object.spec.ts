import {LowerParameter} from '../../dist/validator/lower.js';
...
describe(`compiler compatible`,function() {
    ...
    const validator = LowerParameter<string>({maximum:1, inclusive:false, message:LowerString.Parameter});
...
describe(`value equal to minimum`,function() {
    ...
    describe(`inclusive`,function() {
        ...
        const validator = LowerParameter<string>({maximum:1, inclusive:true, message:LowerString.Parameter});
